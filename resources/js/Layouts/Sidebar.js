...
function Sidebar(props) {
  return (
    <aside
      className="fixed inset-0 z-20 flex-none hidden h-full w-72 lg:static lg:h-auto lg:overflow-y-visible lg:pt-0 lg:w-52 lg:block"
      aria-label="Sidebar"
    >
      <div className="h-full overflow-y-auto py-4 px-0 bg-white rounded dark:bg-gray-800">
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span className="text-sm flex-1 ml-3 whitespace-nowrap">
                Usuarios
              </span>
